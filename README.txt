...
## 📈 Bag Size별 성능 비교 (WSI Instance-Level) || 2025-10-23 기준

| **Bag Size** | **Accuracy**      | **AUC**       | **Sensitivity**   | **Specificity** | **Precision (PPV)** | **NPV**       | **F1-score**      |
| ------------ | ----------------- | ------------- | ----------------- | --------------- | ------------------- | ------------- | ----------------- |
| **500**      | **0.840 ± 0.058** | 0.893 ± 0.042 | **0.880 ± 0.051** | 0.800 ± 0.131   | —                   | —             | **0.849 ± 0.046** |
