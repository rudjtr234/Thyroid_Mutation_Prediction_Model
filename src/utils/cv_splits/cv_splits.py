...
if __name__ == "__main__":
    # 데이터 경로 설정
    meta_dir = "/data/143/member/jks/Thyroid_Mutation_dataset/embeddings/final_meta_dataset_v0.1.0/embeddings/selected_slides"
    nonmeta_dir = "/data/143/member/jks/Thyroid_Mutation_dataset/embeddings/final_nonmeta_dataset_v0.1.0/npy"
    save_dir = "./cv_splits"

    # 5-Fold CV 생성 (balanced=True로 meta를 892개만 샘플링)
    ...
    save_path = Path(save_dir) / f"cv_splits_balanced_k{cv_splits['k_folds']}_seed{cv_splits['seed']}_v0.3.0.json"
